...
const packages = [
  ...
  },
  {
    ...
    places: ["Gaya", "Bodh Gaya", "Varanasi", "Prayagraj", "Ayodhya"],
    inclusions: [
      { icon: Plane, text: "Pickup & Drop as Applicable" },
      { icon: Users, text: "Private Vehicle Throughout" },
      { icon: Utensils, text: "Daily Breakfast" },
      { icon: Ticket, text: "Hotel Accommodation" },
    ],
    details: [
      "Vishnupad Temple & Mahabodhi Temple, Gaya/Bodh Gaya",
      "Kashi Vishwanath Darshan & Ganga Aarti, Varanasi",
      "Sunrise Ganga Boat Ride & Sankat Mochan Temple, Varanasi",
