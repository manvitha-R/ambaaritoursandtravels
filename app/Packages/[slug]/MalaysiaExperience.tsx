...
// 0 Malaysia.png poster (cover tile), 1 Independence Square/Kuala Lumpur,
// 2 KL Tower, 3 Batu Caves, 4 Genting Highlands cable car,
// 5 Petronas Twin Towers, 6 Chinese Temple.
const DAY_IMAGE_INDEX: Record<number, number> = { 1: 1, 2: 3, 3: 6 };

export default function MalaysiaExperience({
  pkg,
  itinerary,
  highlights,
  bookNowHref,
        ...
        {mosaicImages.length <= 1 && (
          <div className="mb-5">
            ...
            <h1 className="text-lg md:text-2xl font-semibold text-white">
              Malaysia <span className="text-amber-200 font-normal text-sm md:text-base">· 2 Nights / 3 Days</span>
            </h1>
          </div>
        )}
        {mosaicImages.length > 1 && (
