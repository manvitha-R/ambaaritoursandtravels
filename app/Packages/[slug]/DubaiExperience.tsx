...
// 0 Dubai.png poster (cover tile), 1 Dhow Cruise, 2 Dubai Mall, 3 Museum of
// the Future, 4 Dubai Frame. Days 5-6 (Abu Dhabi excursion / departure) have
// no dedicated photo, so they cycle back through the Dubai city shots.
const DAY_IMAGE_INDEX: Record<number, number> = { 1: 1, 2: 2, 3: 3, 4: 4, 5: 1, 6: 2 };

export default function DubaiExperience({
  pkg,
  itinerary,
  highlights,
  bookNowHref,
  ...
  const images: string[] = pkg.images?.length ? pkg.images : ["/Images/Dubai.png"];
        ...
        {mosaicImages.length <= 1 && (
          <div className="mb-5">
            ...
            <h1 className="text-lg md:text-2xl font-semibold text-white">
              Dubai &amp; Abu Dhabi <span className="text-amber-200 font-normal text-sm md:text-base">· 5 Nights / 6 Days</span>
            </h1>
          </div>
        )}
        {mosaicImages.length > 1 && (
