...
// 0 Panchabhoota.png poster (cover tile), 1 Srikalahasti (Vayu), 2 Kanchipuram
// (Prithvi), 3 Thiruvannamalai (Agni), 4 Chidambaram (Akasha) — one photo per
// day of the yatra.
const DAY_IMAGE_INDEX: Record<number, number> = { 1: 1, 2: 2, 3: 3, 4: 4 };

export default function PanchabhootaExperience({
  pkg,
  itinerary,
  highlights,
  bookNowHref,
  ...
  const images: string[] = pkg.images?.length ? pkg.images : ["/Images/Panchabhoota.png"];
        ...
        {mosaicImages.length <= 1 && (
          <div className="mb-5">
            ...
            <h1 className="text-lg md:text-2xl font-semibold text-white">
              Panchabhoota Yatra <span className="text-amber-200 font-normal text-sm md:text-base">· 3 Nights / 4 Days</span>
            </h1>
          </div>
        )}
        {mosaicImages.length > 1 && (
