...
// 0 Ujjain.png poster (cover tile), 1 Ujjain Corridor, 2 Omkareshwar Temple.
// Day 3 (Indore local sightseeing / departure) has no dedicated photo, so it
// falls back to the poster.
const DAY_IMAGE_INDEX: Record<number, number> = { 1: 1, 2: 2, 3: 0 };

export default function UjjainExperience({
  pkg,
  itinerary,
  highlights,
  bookNowHref,
  ...
  const images: string[] = pkg.images?.length ? pkg.images : ["/Images/Ujjain.png"];
