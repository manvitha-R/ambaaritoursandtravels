...
// 0 Vietnam.png poster (cover tile), 1 Pearl Farm/Ha Long Bay, 2 Temple of Literature,
...
export default function VietnamExperience({
  ...
  const images: string[] = pkg.images?.length ? pkg.images : ["/Images/Vietnam.png"];
        ...
        {mosaicImages.length <= 1 && (
          <div className="mb-5">
            ...
            <h1 className="text-lg md:text-2xl font-semibold text-white">
              Vietnam <span className="text-amber-200 font-normal text-sm md:text-base">· 6 Nights / 7 Days</span>
            </h1>
          </div>
        )}
        {mosaicImages.length > 1 && (
