...
// 0 Shirdi.png poster (cover tile), 1 Trimbakeshwar Jyotirlinga, 2 Shirdi
// temple (night), 3 Ellora Caves, 4 Shani Shingnapur, 5 Grishneshwar
// Jyotirlinga. Day 1 covers Trimbakeshwar through the Shirdi darshan; day 2
// covers Shani Shingnapur through Ellora and Grishneshwar.
const DAY_IMAGE_INDEX: Record<number, number> = { 1: 1, 2: 3 };

export default function ShirdiExperience({
  pkg,
  itinerary,
  highlights,
  bookNowHref,
  ...
  const images: string[] = pkg.images?.length ? pkg.images : ["/Images/Shirdi.png"];
        ...
        {mosaicImages.length <= 1 && (
          <div className="mb-5">
            ...
            <h1 className="text-lg md:text-2xl font-semibold text-white">
              Shirdi Sai Baba Darshan <span className="text-amber-200 font-normal text-sm md:text-base">· 1 Night / 2 Days</span>
            </h1>
          </div>
        )}
        {mosaicImages.length > 1 && (
