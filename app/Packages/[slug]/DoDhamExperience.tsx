...
// 0 Do-dham.png poster (cover tile), 1 Rudraprayag, 2 Kedarnath, 3 Guptkashi,
// 4 Badrinath, 5 Mana Village. Days 1 (Haridwar) and 8 (departure) have no
// dedicated photo, so they fall back to the poster; day 7 (the return leg
// through Rudraprayag) reuses that shot.
const DAY_IMAGE_INDEX: Record<number, number> = { 1: 0, 2: 1, 3: 2, 4: 3, 5: 4, 6: 5, 7: 1, 8: 0 };

export default function DoDhamExperience({
  pkg,
  itinerary,
  highlights,
  bookNowHref,
  ...
  const images: string[] = pkg.images?.length ? pkg.images : ["/Images/Do-dham.png"];
        ...
        {mosaicImages.length <= 1 && (
          <div className="mb-5">
            ...
            <h1 className="text-lg md:text-2xl font-semibold text-white">
              Do Dham Yatra <span className="text-amber-200 font-normal text-sm md:text-base">· 7 Nights / 8 Days</span>
            </h1>
          </div>
        )}
        {mosaicImages.length > 1 && (
