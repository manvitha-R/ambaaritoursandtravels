  ...
  return (
    <div className="fixed bottom-24 right-6 z-40 flex flex-col items-center gap-3">
      ...
      <a
        ...
        className="group relative w-13 h-13 p-3 bg-green-500 hover:bg-green-400 rounded-full shadow-2xl shadow-green-500/40 transition-all duration-300 hover:scale-110"
      >
      ...
      {isVisible && (
        <button
          ...
          className="group relative p-3 bg-gradient-to-r from-amber-500 to-orange-600 text-black rounded-full shadow-2xl shadow-amber-500/40 transition-all duration-300 hover:scale-110"
        >
